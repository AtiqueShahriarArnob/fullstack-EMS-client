                ...
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr className="border-t border-slate-100">
                            ...
                            <td className='py-3 px-4 text-right text-slate-900 font-medium'>-${payslip.deduction?.toLocaleString()}</td>
                        </tr>
                        <tr className="border-t-2 border-slate-200 bg-slate-50">
                            <td className='py-3 px-4 font-bold text-slate-900'>Net Salary</td>
                            <td className='py-3 px-4 text-right text-slate-900 font-bold text-lg'>${payslip.netSalary?.toLocaleString()}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
