            ...
            >
                ...
                <form className="p-6 space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className='flex gap-3 pt-2'>
                        ...
                        <button type='submit ' disable={loading} className='btn-primary flex justify-center items-center gap-2 flex-1'>
                            {loading && <Loader2Icon className='w-4 h-4 animated-spin'></Loader2Icon>}
                            Update Password
                        </button>
                    </div>
                </form>
