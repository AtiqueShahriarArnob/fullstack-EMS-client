...
const SideBar = () => {
        ...
        <>
            ...
            <div className="p-5 border-t border-white/10">
                <button
                    ...
                    className="w-full bg-red-500 hover:bg-red-600 py-2.5 rounded-lg transition text-white font-medium"
                >
                    Logout
                </button>
            </div>
    ...
    return (
        <>
            ...
            {/* Desktop Sidebar */}
            <aside className="hidden lg:flex flex-col h-screen w-64 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white shrink-0 border-r border-white/10">
                {sideBarContent}
            </aside>
