...
const SideBar = () => {
    ...
    const sideBarContent = (
        <>
            ...
            <div className='p-5 border-t border-white/10'>
                ...
                <button className='w-full bg-red-500 hover:bg-red-600 py-2 rounded-lg transition text-white'>
                    Logout
                </button>
    ...
    return (
        <>
            ...
            {/* Mobile Sidebar */}
            <aside
                className={`lg:hidden fixed inset-y-0 left-0 w-72 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col transform transition-transform duration-300 ${mobileOpen
                    ? "translate-x-0"
                    : "-translate-x-full"
                    }`}
            >
